...
World = nil
-----------------------------------
local crafting = "Please select which kind of armor you would like to make"
----------------------------------------------
banList = {}
pluginList = {}
...
local helptext = "Welcome to Rage Fire!\
 \
  Server Commands\
...
local Quest = "Please select what level quests you would like to do."

local servertext = "\Server commands:\
/leaderboard - Shows who has collected the most gold\
/housing - Opens up the housing menu (/h)\
/character - Shows where you are currently bound (/c)\ "
...
-------------------Start of any code messages in chat with a / in front of them---------------------
...
--------------------------------------------------Unique Server Commands-----------------------------------------------------------
		elseif cmd[1] == "crafting" then

            Players[pid].currentCustomMenu = "crafting menu"
            menuHelper.displayMenu(pid, Players[pid].currentCustomMenu)

        elseif cmd[1] == "quest" then

            Players[pid].currentCustomMenu = "quest menu"
            menuHelper.displayMenu(pid, Players[pid].currentCustomMenu)
			-----------------------------------------------------------------------------------------------------------
        ...
        elseif cmd[1] == "help" then
            ...
            -------
                ...
                Players[pid].currentCustomMenu = "help menu"
                menuHelper.displayMenu(pid, Players[pid].currentCustomMenu)
            end
			------- I added this for testing
			
			elseif cmd[1] == "QuestB" then
			Players[pid].isReadingQuestBPage = 1
			tes3mp.CustomMessageBox(pid, -1, questB .. "\n", "Exit;Test1;Test2")
