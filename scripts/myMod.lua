...
Methods.OnGUIAction = function(pid, idGui, data)
	...
	--[[elseif idGui == -1 and Players[pid].isChoosingWeapon then
	
		weaponButtonIds = {}
		weaponButtonIds["Longsword"] = "0"
		weaponButtonIds["Shortsword"] = "1"
		weaponButtonIds["Mace"] = "2"
		weaponButtonIds["Axe"] = "3"
		weaponButtonIds["Spear"] = "4"
		weaponButtonIds["Bow"] = "5"
		
		Players[pid].isChoosingWeapon = false
		Players[pid].data.startingWeapon = tableHelper.getIndexByPattern(weaponButtonIds, data)
		tes3mp.CustomMessageBox(pid, -1, "You've picked " .. Players[pid].data.startingWeapon .. "\n", "Ok")]]
...
Methods.OnPlayerEndCharGen = function(pid)
    if Players[pid] ~= nil then
        ...
        Players[pid].currentCustomMenu = "choose homecity"
